...
description: >
   Reviewing CS 101 database topics and exploring its simulation in C++
...
---
For this pair-programming project, you will write a C++ program to simulate database CRUD functionality (i.e., creating, reading, updating, and deleting records).
